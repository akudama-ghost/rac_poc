...
export class RacCarServicePage {
  readonly page: Page;

  // Header / navigation
  readonly siteHeader: Locator;
  readonly navCarService: Locator;
  ...
  constructor(page: Page) {
    ...
    this.navCarService = page.getByRole('link', { name: /Car Service/i });

    // Hero section
    this.heroTitle = page.getByRole('heading', { name: /Car Service/i });
  ...
  // Navigation
  async gotoCarService() {
    await this.page.goto('https://www.rac.co.uk/car-care/car-service', { waitUntil: 'domcontentloaded' });
  ...
  async clickBookNow() {
    ...
    await expect(this.page).toHaveURL(/book|service/i);
  }

  async clickLearnMore() {
    await this.heroLearnMoreBtn.click();
    await expect(this.page).toHaveURL(/car-service/i);
  }
